...
from ..data import TurboNum, Uint, Sint, Bin, Float
...
class TelegramWrapper(Telegram):
    ...
    Attribute('parameter_mode', Bin,      '0000',  4, True ),
    Attribute('parameter_number', Uint,     0,      11, True ),
    Attribute('parameter_index',  Uint,     0,       8, True ),
    Attribute('parameter_value',  TurboNum, 0,      32, False),
    Attribute('parameter_type',   type,     Uint,   None, False),
    Attribute('control_set',     Bin,      16*'0', 16, True ),
    Attribute('frequency',        Uint,     0,      16, True ),
    Attribute('temperature',      Sint,     0,      16, True ),
    Attribute('current',          Uint,     0,      16, True ),
    Attribute('voltage',          Uint,     0,      16, True ),
    ...
    def parameter_type(self):
        if not self._parameter:
            return super()._parameter_type()
        return self._parameter.type_
