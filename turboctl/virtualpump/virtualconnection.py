...
class ConnectionComponent(VirtualConnection):
    ...
    :class:~`turboctl.virtualpump.virtualpump.VirtualPump`
    that handles the virtual serial connection between the user and the pump.
    
    Attributes:
        process_query: The method used for processing an input telegram and forming input and forming output.
            Its signature should be
            ::
    ...
    def __init__(self, process_query):
        """Initialize a new :class:`ConnectionComponent`.
        ...
        """
        super().__init__(process=self.process, buffer_size=24)
